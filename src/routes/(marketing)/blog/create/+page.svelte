	...
	<div class="p-8 bg-white rounded-lg border-gray-200 shadow-2xl mb-8">
		{#if locked}
			<div class="w-1/2 mx-auto text-center">
				<h2 class="font-bold tracking-tight text-2xl">Admin Login</h2>
				<p class="text-gray-500 m-4">Enter the admin password</p>
				<form on:submit={checkPassword}>
					<input type="password" bind:value={password} class="w-full rounded-md border-gray-500" />
					<input type="submit" class="bg-primary-300 text-white rounded-md w-1/2 py-2 mt-4" />
				</form>
			</div>
		{:else}
