<div class="relative isolate pt-24 pb-32 sm:pt-32">
	<div
		...
		>
			...
			>
				<blockquote class="p-12 text-xl font-semibold leading-8 tracking-tight text-gray-900">
					<p>
						"Portfolio Labs has revolutionized the way I manage my investments. The platform's
						insights into asset allocation and direct indexing have helped me optimize my portfolio
						and achieve better returns. I highly recommend it to anyone looking to take control of
						their finances."
					</p>
				</blockquote>
			...
			<div class="space-y-8 xl:contents xl:space-y-0">
				<div class="space-y-8 xl:row-span-2">
					<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
						<blockquote class="text-gray-900">
							<p>
								"As an investment manager, Portfolio Labs has been an invaluable tool for me and my
								team. The platform's advanced analytics and historical performance tracking have
								allowed us to better serve our high net worth clients and make informed investment
								decisions."
							</p>
						</blockquote>
				...
				<div class="space-y-8 xl:row-start-1">
					<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
						<blockquote class="text-gray-900">
							<p>
								"Portfolio Labs has been an excellent addition to our institutional investment
								strategy. The platform's advanced analytics and reporting capabilities have allowed
								us to better understand our portfolio's performance and make data-driven decisions.
								It's an essential tool for any serious investor."
							</p>
						</blockquote>
						<figcaption class="mt-6 flex items-center gap-x-4">
							<img
			...
			<div class="space-y-8 xl:contents xl:space-y-0">
				<div class="space-y-8 xl:row-start-1">
					<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
						<blockquote class="text-gray-900">
							<p>
								"Portfolio Labs has helped me streamline my investment process and save valuable
								time. The platform's tax loss harvesting feature has also helped me minimize my tax
								liabilities, which has been a game-changer. I couldn't be happier with the results."
							</p>
						</blockquote>
						<figcaption class="mt-6 flex items-center gap-x-4">
							<img
				...
				<div class="space-y-8 xl:row-span-2">
					<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
						<blockquote class="text-gray-900">
							<p>
								"I was skeptical at first, but Portfolio Labs exceeded my expectations. The
								platform's user-friendly interface and personalized insights have made it easy for
								me to manage my portfolio and achieve my financial goals. I would recommend it to
								anyone looking to take their investments to the next level."
							</p>
						</blockquote>
						<figcaption class="mt-6 flex items-center gap-x-4">
							<img
