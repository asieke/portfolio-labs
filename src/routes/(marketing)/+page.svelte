	...
	<header class="absolute inset-x-0 top-0 z-50">
		<nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
			...
			<div class="hidden lg:flex lg:flex-1 lg:justify-end">
				{#if !session}
					<a href="/signin" class="text-sm font-semibold leading-6 text-white">Log in <span aria-hidden="true">&rarr;</span></a>
				{:else}
					<a href="/dashboard" class="text-sm font-semibold leading-6 text-white">Dashboard<span aria-hidden="true">&rarr;</span></a>
				{/if}
			</div>
		</nav>
			...
			<div class="mx-auto max-w-7xl px-6 lg:px-8">
				<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
					...
					<div class="text-center">
						<h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Discover deeper insights about your Portfolio</h1>
						<p class="mt-6 text-lg leading-8 text-gray-300">Get started today</p>
						<GetStarted />
					</div>
				</div>
				...
				<div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
					<figure class="relative isolate pt-6 sm:pt-12">
						...
						<blockquote class="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
							<p>
								Gravida quam mi erat tortor neque molestie. Auctor aliquet at porttitor a enim nunc suscipit tincidunt nunc. Et non lorem tortor posuere. Nunc eu scelerisque interdum eget tellus non
