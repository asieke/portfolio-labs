...
<p class="mt-6 leading-7 text-slate-500">
	...
	Bitcoin showed the highest annual growth of 85.13%, followed by the U.S. Equity Total Market and Vanguard 2050 Fund with 16.22% and 11.33% returns, respectively. Past performance does not guarantee
	future results.
</p>
