...
<h1>Terms and Conditions</h1>
  ...
  <p>
    ...
    using the Portfolio Labs website (the "Service") operated by Portfolio Labs ("us", "we", or
    "our").
  </p>
  <p>
  ...
  <p>
    ...
    same conditions unless you cancel it or Portfolio Labs cancels it. You may cancel your
    Subscription renewal either through your online account management page or by contacting
    Portfolio Labs customer support team.
  </p>
  <h2>Limitation of Liability</h2>
  <p>
    In no event shall Portfolio Labs, nor its directors, employees, partners, agents, suppliers,
  ...
  <p>
    Portfolio Labs, its subsidiaries, affiliates, and its licensors do not warrant that a) the
